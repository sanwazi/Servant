...
public abstract class GeneralConstants {
    ...
    public static String MINUTE_IDENTIFIER = "minuteIdentifier";
    public static String DAY_IDENTIFIER = "dayIdentifier";
    public static String YEAR_IDENTIFIER = "yearIdentifier";
    public static String MONTH_IDENTIFIER = "monthIdentifier";
    public static String DATE_PICKED_IDENTIFIER = "datePickedIdentifier";
}
